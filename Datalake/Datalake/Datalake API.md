...
Если Old не указывается, используется Young с отброшенным временем (начало суток).<br/>
Если указывается Exact, Young и Old будут приравнены к Exact.<br/>
Если не указана ни одна дата, в качестве ответа будут возвращены текущие значения.<br/>
<br/>
