...
[Scoped]
public class UserGroupsRepository(InventoryDbContext context) : DbRepository<UserGroup, Guid>(context), IUserGroupsRepository
{
	public override Task<UserGroup?> GetByIdAsync(Guid id, CancellationToken ct = default)
	{
