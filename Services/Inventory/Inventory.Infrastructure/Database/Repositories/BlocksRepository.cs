...
[Scoped]
public class BlocksRepository(InventoryDbContext context) : DbRepository<Block, int>(context), IBlocksRepository
{
	public override Task<Block?> GetByIdAsync(int id, CancellationToken ct = default)
	{
