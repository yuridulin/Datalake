...
public class DatalakeSessionsStore
{
	...
	/// <returns>Информация о сессии</returns>
	public async Task<UserSessionInfo> OpenSessionAsync(UserAccessEntity userAuthInfo, UserType type)
	{
		...
		using var db = scope.ServiceProvider.GetRequiredService<InventoryLinqToDbContext>();
