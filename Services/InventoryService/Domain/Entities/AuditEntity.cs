...
public record class AuditEntity
{
	...
	public AuditEntity(LogCategory category, string message, string? details, LogType type = LogType.Information)
	{
		Category = category;
		Type = type;
		Text = message;
	...
	/// Дата записи
	/// </summary>
	public DateTime Date { get; private set; } = DateFormats.GetCurrentDateTime();
	...
	/// </summary>
	public SourceEntity? AffectedSource { get; set; }

	/// <summary>
	/// Затронутый тег
	/// </summary>
	public TagEntity? AffectedTag { get; set; }

	/// <summary>
	/// Затронутый блок
	/// </summary>
	public BlockEntity? AffectedBlock { get; set; }
	...
	/// </summary>
	public UserGroupEntity? AffectedUserGroup { get; set; }

	/// <summary>
	/// Затронутое правило доступа
	/// </summary>
	public AccessRuleEntity? AffectedAccessRights { get; set; }
}
