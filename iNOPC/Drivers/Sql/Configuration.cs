	...
	public class Configuration
	{
		...
		public static string GetPage(string json)
		{
			...
			html +=
				...
				"<br />Код должен возвращать таблицу с двумя столбцами: [ имя переменной , значение ]" +
				"<br />Подстановка дат: AggHourStart, AggHourEnd, AggDayStart, AggDayEnd" +
				"</div>" +
				...
				Html.Textarea("Выполняемый код", nameof(config.Code), config.Code, "width: 100%; min-height: 10em; padding: .5em;");
