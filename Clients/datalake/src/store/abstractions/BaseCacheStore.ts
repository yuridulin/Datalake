...
/**
 * Базовый класс для сервисов данных с кэшированием.
 * Предоставляет общую обработку запросов и метрики последнего обращения к API.
 * TTL не используется, так как компоненты сами решают, когда обновить данные - как правило при каждом монтировании.
 */
